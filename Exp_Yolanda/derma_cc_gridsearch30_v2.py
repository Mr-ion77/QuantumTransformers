...
df.to_csv(f'derma_results/low_res/{carpeta}/results_grid_search_cc.csv', mode='a', header=True, index=False)
                        ...
                        for mlp in mlp_size:
                            for patch in patch_size:
                                for wd in wds:
                                    ...
                                    df.to_csv(f'derma_results/low_res/{carpeta}/results_grid_search_cc.csv', mode='a', header=False, index=False)
