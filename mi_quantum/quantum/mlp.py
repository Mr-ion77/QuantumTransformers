...
def MLP(hidden_size: int,  qml_backend: str = "pennylane", qdevice: str = "default.qubit", qdiff_method: str = "best"):
    if qml_backend == "pennylane":
        #from quantum_transformers.qmlperfcomp.torch_backend.quantum.pennylane_backend_Carlos import QuantumLayer
        from mi_quantum.quantum.pennylane_backend_Carlos import QuantumLayer
