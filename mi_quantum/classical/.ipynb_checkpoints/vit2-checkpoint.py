...
class VisionTransformer(nn.Module):
    def __init__(self, data_type, img_size, num_channels, num_classes, patch_size, hidden_size, num_heads, num_transformer_blocks, mlp_hidden_size,
        ...
        self.prueba = [f"CL, data_type={data_type}, patch_size={patch_size}, hidden_size={hidden_size}, num_heads={num_heads}, num_transformer_blocks={num_transformer_blocks}, mlp_hidden_size={mlp_hidden_size}"]
